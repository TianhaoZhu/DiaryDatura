...
/**
 * Created by cym1497 on 2017/7/21.
 */
...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = getResources().getDrawable(R.drawable.style_clear_selector);
        }

        mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(), mClearDrawable.getIntrinsicHeight());

        int paddingRight = getPaddingRight()>0 ? getPaddingRight() : 6;
